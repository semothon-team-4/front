...
class _ScanScreenState extends State<ScanScreen>
  ...
  Widget build(BuildContext context) {
    // 결과 화면 — 택 스캔 결과 (화면13)
    if (_resultPage == 0) return _TagScanResultScreen(image: _scannedImage, mode: _mode, onNavigate: widget.onNavigate, onBack: () => setState(() => _resultPage = -1), onSave: _saveToWardrobe, onReset: _reset);
                  ...
                  child: Column(
                    ...
                    children: [
                      CircularProgressIndicator(
                          color: Color(0xFF8FEAFD), strokeWidth: 3),
                      SizedBox(height: 20),
                      Text('분석 중...',
                          style: TextStyle(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.camera_alt, color: Color(0xFF1D1B20), size: 32),
                        ),
                      ),
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: const Color(0x5542A5F5), width: 1),
                ),
              ),
      ...
      if (_scannedImage != null) {
        try {
          imagePath = await ImageService.saveImageLocally(
              _scannedImage!, 'scan_${now.millisecondsSinceEpoch}.jpg');
        } catch (_) {}
      }
      try {
...
class _TagScanResultScreen extends StatelessWidget {
  ...
  static const _careItems = [
    (Icons.local_laundry_service_outlined, '세탁기 사용 가능', '30°C 이하의 미지근한 물에서 세탁기 사용 가능'),
                              ...
                              : Container(
                                  ...
                                  child: const Center(
                                    child: Icon(Icons.dry_cleaning,
                                        color: Color(0xFF8FEAFD), size: 60),
                                  ),
                                ),
                        ),
                      ],
                          ...
                          Row(
                            children: [
                              ...
                              const Icon(Icons.arrow_forward,
                                  color: Color(0xFF1D1B20), size: 20),
                            ],
                          ),
                          const SizedBox(height: 6),
                          const Text('소재/오염도/손상도까지 분석 가능',
                              style: TextStyle(
                                  fontSize: 11, color: Color(0xFF5D7A8A))),
                        ],
                      ),
                    ),
                  ],
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text(
                              ...
                              style: TextStyle(
                                  fontSize: 12, color: Color(0xFF292929)),
                            ),
                          ),
                        ],
                      ),
                      ...
                      onTap: () => showDialog(
                        ...
                        builder: (_) => AlertDialog(
                          ...
                          content: const Text(
                            ...
                            style: TextStyle(
                                fontSize: 13, color: Color(0xFF1A39FF),
                                height: 1.7),
                          ),
                          actions: [
                            TextButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.info_outline,
                              size: 13, color: Color(0xFF545454)),
                          const SizedBox(width: 4),
                          const Text('등급 기준',
                              style: TextStyle(
                                  fontSize: 11, color: Color(0xFF545454))),
                        ],
                      ),
                    ),
                    const SizedBox(height: 16),
                    ...
                    // 소재 정보
                    const Text('데님 팬츠 · 면 98% / 폴리에스테르 2%',
                        style: TextStyle(
                            fontSize: 12, color: Color(0xFF414141))),
                    const SizedBox(height: 20),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(label,
            style: const TextStyle(
                fontSize: 11, color: Color(0xFF1D1B20))),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? const Color(0xFF8FEAFD) : Colors.white.withValues(alpha: 0.15),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: active ? const Color(0xFF8FEAFD) : Colors.white.withValues(alpha: 0.4),
            width: 1.5,
          ),
        ),
        child: Text(
